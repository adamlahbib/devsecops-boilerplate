...
REFER TO THIS [JOB LOGS](https://github.com/adamlahbib/boilerplate/actions/runs/11922712020/job/33229562109?pr=11)
...
REFER TO THIS [JOB LOG](https://github.com/adamlahbib/boilerplate/actions/runs/11924994674)

![](2024-11-20-02-33-26.png)
...
REFER TO THIS [JOB LOGS](https://github.com/adamlahbib/boilerplate/actions/runs/11922627881/job/33229299694)
...
PROD: REFER TO THIS [JOB LOGS](https://github.com/adamlahbib/boilerplate/actions/runs/11922627881/job/33229354469)
...
e.g. https://monitoring.tailcf97d7.ts.net to access Grafana which uses the `admin:boilerplate-operator` credentials (just for the task, I wouldn't write it in clear text otherwise). The password was pre-set in the GitHub Actions secrets and the username is the default Grafana admin username.
